...
class GameTransactionLiveHistory extends Resource
{ 

    public static function label()
    {
        return 'On-going Game Transactions';
    }
    ...
    public static $model = \App\Models\Slotlayer\GametransactionsLive::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            DateTime::make('Timestamp', 'created_at')->hideWhenCreating()->readonly()->sortable(),
            Text::make('TX', 'txid'),
